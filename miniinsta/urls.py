...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name="miniinsta/login.html"), name="login"),
    path(r'logout/', auth_views.LogoutView.as_view(next_page='logout_confirmation'), name="logout"),
    path(r'logout_confirmation/', TemplateView.as_view(template_name='miniinsta/logged_out.html'), name="logout_confirmation"),
